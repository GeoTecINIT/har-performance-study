...
from lib.pipeline.data_loading import load_data, load_dataset
from lib.pipeline.data_fusion import fuse_data
from lib.pipeline.feature_extraction import apply_feature_extraction
from lib.pipeline.raw_data_processing import scale, windows, compute_best_class, count_data
...
if __name__ == '__main__':
    ...
    raw_data = load_dataset(args.input_data_path)
